...
//f ($result = $mysqli->query($query)) {
   ...
   // echo "<div class='row'>";
    ...
    echo "<div id='snackbar' style='font-size: 13px'>Register/login to get connected..<a href='index.php' style='font-size: 13px'>Click here</a></div>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
  ...
  <div class="card-body text-secondary">
    <h5 class="card-title">Some contents here..</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.Some quick contents if applicable text to build on the card title and make up the bulk.Some quick contents if applicable text to build on the card title and make up the bulkSome quick contents if applicable text to build on the card title and make up the bulkSome quick contents if applicable text to build on the card title and make up the bulkSome quick contents if applicable text to build on the card title and make up the bulk</p>
  </div>
</div>
<br>
<div class="card border-secondary mb-3" style="max-width: 18rem;">
