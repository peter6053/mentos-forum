...
echo "<table class='table'>";
  echo "<tbody>";
    ...
    <br>
    <div>
 <p><button onclick='myFunction()'>Connect</button></p>
 <div id='snackbar'><strong>Register/login to get connected..<a href='index.php' style='font-size: 16px'>Click here</a></strong></div>
</div>
